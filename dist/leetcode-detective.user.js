...
(function () {
  ...
  function App() {
    ...
    return jsxRuntimeExports.jsx("div", { className: "fixed bottom-6 right-6 z-50 flex flex-col items-end animate-fade-in-up", children: jsxRuntimeExports.jsxs("div", { className: "bg-gray-900 text-white w-96 rounded-xl shadow-2xl border border-gray-700 flex flex-col overflow-hidden max-h-[80vh]", children: [
...
jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: jsxRuntimeExports.jsxs("div", { children: [
...
jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", className: "h-5 w-5", viewBox: "0 0 20 20", fill: "currentColor", children: jsxRuntimeExports.jsx("path", { fillRule: "evenodd", d: "M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z", clipRule: "evenodd" }) })
          }
        )
      ] }),
...
jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: `w-full py-2 rounded font-bold text-sm transition-all shadow-lg flex items-center justify-center gap-2
                  ${loading ? "bg-gray-700 text-gray-400 cursor-not-allowed" : "bg-gradient-to-r from-green-600 to-green-700 hover:from-green-500 hover:to-green-600 text-white"}`,
              children: loading ? jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: "Processing..." }) : jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: " Scan Last 5 Contests" })
            }
          )
        ] }),
jsxRuntimeExports.jsx("div", { className: "space-y-3", children: history.map((item) => {
          ...
          return jsxRuntimeExports.jsxs("div", { className: "bg-gray-800 rounded-lg border border-gray-700 overflow-hidden shadow-sm transition-all hover:border-gray-500", children: [
...
jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: jsxRuntimeExports.jsx("span", { className: "font-bold text-sm text-gray-200 block truncate", children: item.contest.title })
                }
              ),
...
jsxRuntimeExports.jsx("span", { className: "animate-spin", children: "⏳" }),
            ...
            ] }) : Object.keys(analysisResults).length > 0 ? Object.entries(analysisResults).map(([qTitle, report]) => jsxRuntimeExports.jsxs("div", { className: "mb-3 last:mb-0", children: [
...
jsxRuntimeExports.jsx("span", { className: `${report.color} bg-gray-900 px-1.5 py-0.5 rounded border border-gray-700`, children: report.status })
              ] }),
